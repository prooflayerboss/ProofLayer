(function() {
  ...
  function renderCard(t) {
    ...
    if (isScreenshot && t.photoUrl) {
      screenshotContent = '<div class="pl-screenshot"><img src="' + t.photoUrl + '" alt="Screenshot" style="width:100%;border-radius:8px;margin:10px 0"/></div>';
    }
  ...
  function loadTestimonials() {
    ...
    fetch(apiUrl)
      ...
      .then(function(data) {
        ...
        contentDiv.innerHTML = '<div class="pl-grid">' + cardsHtml + '</div>';
      })
      .catch(function(err) {
