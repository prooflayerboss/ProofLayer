...
import { getAuthenticatedFounder } from '@/lib/first100-utils';
...
export async function GET(
  ...
  try {
    ...
    apiLogger.error('Get product error', { error: String(error) });
...
export async function PATCH(
  ...
  try {
    ...
    apiLogger.error('Update product error', { error: String(error) });
...
export async function DELETE(
  ...
  try {
    ...
    apiLogger.error('Delete product error', { error: String(error) });
