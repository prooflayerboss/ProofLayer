...
const platforms = [
  { name: 'WordPress', compatible: true, note: 'Works with any WordPress theme' },
  { name: 'Webflow', compatible: true, note: 'Simple embed code integration' },
  { name: 'Wix', compatible: true, note: 'Use custom HTML element' },
  { name: 'Squarespace', compatible: true, note: 'Add via code injection' },
  { name: 'Shopify', compatible: true, note: 'Perfect for product reviews' },
  { name: 'Framer', compatible: true, note: 'Embed in any component' },
  { name: 'React', compatible: true, note: 'Native component support' },
  { name: 'Next.js', compatible: true, note: 'Server & client components' },
  { name: 'Vue.js', compatible: true, note: 'Simple integration' },
  { name: 'HTML', compatible: true, note: 'Works anywhere HTML works' },
];
