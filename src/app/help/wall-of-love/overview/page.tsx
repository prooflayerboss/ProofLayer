    ...
    >
      ...
      <Section title="How the Wall of Love Works">
        ...
        <Step number={3} title="Content Display">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
            ...
            <div className="border border-gray-200 p-3 rounded-lg">
              ...
              <p className="text-gray-700">
                High-quality images displayed in lightbox view. Click to see full size.
              </p>
            </div>
          </div>
        </Step>
        ...
        <Step number={4} title="Visitor Experience">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            <li><strong>Browse all testimonials</strong> in a beautiful masonry/grid layout</li>
            <li><strong>Filter by type</strong> (text, video, screenshot) using toggle buttons</li>
            <li><strong>Filter by rating</strong> (5 stars, 4+, etc.)</li>
            <li><strong>Watch videos</strong> directly on the page</li>
            <li><strong>View screenshots</strong> in full-screen lightbox</li>
            <li><strong>Share specific testimonials</strong> via social media</li>
          </ul>
        </Step>
      </Section>
