      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            Loved by freelancers, agencies, and creators
          </div>
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
            Don't Just Take Our Word For It
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Join hundreds of happy customers who switched to ProofLayer and never looked back.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          ...
          <div>
            <p className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">10k+</p>
            <p className="text-gray-600 mt-2">Testimonials Collected</p>
          </div>
          <div>
            <p className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">4.9/5</p>
            <p className="text-gray-600 mt-2">Average Rating</p>
          </div>
          <div>
            <p className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">$1k+</p>
            <p className="text-gray-600 mt-2">Saved vs Competitors</p>
          </div>
        </div>
      </div>
    </section>
